<div class="diets index">
	...
	<tr>
		...
		<td><?php echo h($Diet['Diet']['user_id']); ?>&nbsp;</td>
		<td><?php echo h($Diet['Diet']['menu_id']); ?>&nbsp;</td>
		<td><?php echo h($Diet['Diet']['COMMENT']); ?>&nbsp;</td>
		
		

		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $Diet['Diet']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $Diet['Diet']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $Diet['Diet']['id']), array(), __('Are you sure you want to delete # %s?', $Diet['Diet']['id'])); ?>
		</td>
	</tr>
	<?php endforeach; ?>
	</table>
...
<div class="actions">
	...
	<ul>
		...
		<li><!-- <a href="http://oauth.vk.com/authorize?client_id=4438108&redirect_uri=fit_day.com/Diets/&scope=3&response_type=code" title="VK Log in">VK Log in</a> -->
			<?php echo $this->Html->link(__('VK Log in'), array('controller' => 'Diets','action' => 'vklogin'));?></li>
		...
		<li><?php echo $this->Html->link(__('New Diet'), array('controller' => 'Diets', 'action' => 'add')); ?> </li>
		<li><?php echo $this->Html->link(__('List Diet'), array('controller' => 'Diets', 'action' => 'index')); ?> </li>
