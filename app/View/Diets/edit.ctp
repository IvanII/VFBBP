...
<?php echo $this->Form->create('Diet'); ?>
	<fieldset>
		<legend><?php echo __('Edit Diet'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Diet.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Diet.id'))); ?></li>
