<div class="diet view">
<h2><?php echo __('Diet'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($Diet['Diet']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('User_id'); ?></dt>
		<dd>
			<?php echo h($Diet['Diet']['user_id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Menu_id'); ?></dt>
		<dd>
			<?php echo h($Diet['Diet']['menu_id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Comment'); ?></dt>
		<dd>
			<?php echo h($Diet['Diet']['COMMENT']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Diet'), array('action' => 'edit', $Diet['Diet']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Diet'), array('action' => 'delete', $Diet['Diet']['id']), array(), __('Are you sure you want to delete # %s?', $Diet['Diet']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Diets'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Diet'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<tr>
		...
		<th><?php echo __('Diet Id'); ?></th>
		<th><?php echo __('Menu Id'); ?></th>
		<th><?php echo __('COMMENT'); ?></th>
		<th class="actions"><?php echo __('Actions'); ?></th>
	</tr>
	<?php foreach ($Diet['Diet'] as $diet): ?>
		<tr>
...
<div class="related">
	...
	<?php foreach ($Diet['Profile'] as $profile): ?>
		<tr>
			<td><?php echo $profile['id']; ?></td>
			<td><?php echo $profile['Diet_id']; ?></td>
...
<div class="related">
	...
	<?php foreach ($Diet['Sleep'] as $sleep): ?>
		<tr>
			<td><?php echo $sleep['id']; ?></td>
			<td><?php echo $sleep['Diet_id']; ?></td>
...
<div class="related">
	...
	<?php foreach ($Diet['Workout'] as $workout): ?>
		<tr>
			<td><?php echo $workout['id']; ?></td>
			<td><?php echo $workout['Diet_id']; ?></td>
